...
extern NSString * const kErrorNoArduinoIDE;
extern NSString * const kErrorArduinoIDELowVersion;

@class MABoardPackage;
@class MABoardArchitecture;

@interface MABoard : NSObject

@property (nonatomic, copy, readonly) NSString *name;
@property (nonatomic, copy, readonly) NSString *identifier;
@property (nonatomic, strong, readonly) MABoardArchitecture *architecture;
@property (nonatomic, strong, readonly) MABoardPackage *package;
